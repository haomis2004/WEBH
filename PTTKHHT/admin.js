    ...
    <table class="overlayTable table-outline table-content table-header">
        ...
        <tr>
            ...
            <td>
                ...
                var company = ["PepSi", "Mirinda ", "RedBull", "Sting", "7UP", "Mirinda-Xanh","Wake-Up 247","Cà Phê Sữa","Cà Phê Đen","Cà Phê Phố","VinCafe","Cà Phê Capochino","Cà Phê MoCha","Trân Châu Đường Đen","Trà Sữa Khoai Môn","MatCha","Trà Sữa Socala","Sương Sáo","Okeo Cake Cream","Nước ép dâu","Nước ép Cà Rốt ","Nước ép Dưa Hấu","Nước ép Táo","Nước ép Ôỉ","Nước ép Bí Đao","Sinh tố Cam","Sinh tố Dâu","Sinh tố Dưa Hấu","Sinh tố Bơ","Sinh tố Xoài","Sinh tố Thanh Long"];
    ...
    <tr>
        ...
        <td>
            <select>
                ...
                <option value="tragop">Hết hàng</option>
                <option value="giamgia">Còn Hàng</option>
                <option value="giareonline">Đang Nhập Hàng</option>
